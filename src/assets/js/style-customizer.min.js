	...
	****************************************/
	...
	if (!($.cookie('tp_stylesheet'))) {
		...
		if (link.length > 0) {
			...
			link.attr('href', css_path + 'assets/css/skins/' + tp_stylesheet + '.css');
			$('.style-customizer .styleChange li[data-style="' + tp_stylesheet + '"]').addClass("selected");
			if ($(".swicher-title-page-dark").length > 0) {
				document.getElementById("logo_img").src = "assets/images/color-customizer/mass-logo.svg";
			} else {
				if ($("#logo_img").length > 0) {
					document.getElementById("logo_img").src = "assets/images/color-customizer/mass-logo.svg";
				};
				if ($("#logo_dark_img").length > 0) {
					document.getElementById("logo_dark_img").src = "assets/images/color-customizer/mass-logo.svg";
				};
				if ($("#logo-footer").length > 0) {
					document.getElementById("logo-footer").src = "assets/images/color-customizer/mass-logo.svg";
				};
			};
		};
	};
...
*************************/
	$('.style-customizer .styleChange li').on('click', function () {
		if (link.length > 0) {
			...
			$(".style-customizer .styleChange .selected").removeClass("selected");
			$this.addClass("selected");
			link_no_cookie.attr('href', css_path + 'assets/css/skins/' + tp_stylesheet_no_cookie + '.css');
			if ($(".swicher-title-page-dark").length > 0) {
